...
const NAV_ITEMS: NavItem[] = [
  ...
  { screen: 'cloud-governance',       icon: '☁', label: 'Cloud Governance',          phase: 3, coming: true },
  { screen: 'network-substrate',      icon: '⬡', label: 'Network / Substrate',       phase: 2, coming: true },
  { screen: 'advanced-api',           icon: '⇄', label: 'Advanced API',              phase: 2, coming: true },
  { screen: 'ai-agent-governance',    icon: '⬡', label: 'AI Agent Governance',       phase: 3, coming: true },
  { screen: 'evidence-ledger',        icon: '⊞', label: 'Evidence / Ledger',         phase: 2, coming: true },
  { screen: 'reporting-storyboards',  icon: '☰', label: 'Reporting / Storyboards',   phase: 1 },
  { screen: 'secure-channel',         icon: '⊛', label: 'Secure Channel',            phase: 3, coming: true },
  { screen: 'policies-alerts',        icon: '⚑', label: 'Policies / Alerts',         phase: 3, coming: true },
  { screen: 'cp-dp-health',          icon: '⊕', label: 'CP / DP Health',            phase: 2, coming: true },
  { screen: 'scenario-playback',      icon: '▶', label: 'Scenario Playback',         phase: 1 },
  { screen: 'roadmap',                icon: '→', label: 'Roadmap / Next Waves',      phase: 4, coming: true },
];
